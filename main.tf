...
#assinando o endereço elastico de IP na network interface criada na etapa 7
#o aws_eip depende da implantação do gateway da internet, se tentar criala e ligar a um vpc que não tenha
